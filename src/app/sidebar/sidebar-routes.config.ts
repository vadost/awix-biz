...
export const NAVIGATIONS: RouteInfo[] = [
  {path: '/calendar', title: 'Календарь', icon: 'date_range'},
  {path: '/branches', title: 'Филиалы', icon: 'share'},
  {path: '/services', title: 'Услуги', icon: 'assignment'},
  {path: '/employees', title: 'Сотрудники', icon: 'person'},
  {path: '/clients', title: 'Клиенты', icon: 'group'},
  {path: '/statistics', title: 'Статистика', icon: 'assessment'},
  {path: '/booking', title: 'Онлайн-запись', icon: 'speaker_notes'},
  {path: '/account', title: 'Настройки', icon: 'settings'},
];
